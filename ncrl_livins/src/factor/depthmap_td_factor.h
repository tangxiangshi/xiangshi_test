...
class DepthMapTdFactor : public ceres::SizedCostFunction<3, 1, 1>
{
public:
    DepthMapTdFactor(const PointUtility::Tf &_transfo_li_lj, const PointUtility::Tf &_transfo_l_c,
                     const Eigen::Vector3d &_pts_j, const Eigen::Vector3d &_nu, const Eigen::Vector3d &_pts_n,
