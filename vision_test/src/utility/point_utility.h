...
public:
    ...
    /**
     * @brief: a is first frame, b is second frame
     */
    static Tf findF2FTransfo(const Tf transfo_a, const Tf transfo_b)
    {
        Tf transfo_a_b(transfo_a.q.inverse() * transfo_b.q,
                       transfo_a.q.inverse() * (transfo_b.t - transfo_a.t));
        return transfo_a_b;
    }
